    ...
    var urlcnst = require('../../const/api')() +'sib-api/common/buildings/types'
    ...
    var selectzoneid =[]
    var selectzonename =[]
    export default class Typebuilding extends Component<Props> {
     ...
     registerCall(){
      ...
      axios.post(urlcnst,body )
       .then(function (response) {
         alert("the type building was successfully created with id " + response.data);
         //console.log("this.reponse",response.data)
       })
    ...
    render() {
      ...
      <ScrollView>
       ...
       <Text style={styles.input}>Add Type Building</Text>
       ...
       <TouchableOpacity style={styles.submitButtonText} onPress={() => this.onClickListener('sign_up')}>
         <Text style={styles.signUpText}>Add Building Type</Text>
       </TouchableOpacity>
