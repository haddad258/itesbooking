    ...
    var urlcnst = require('../../const/api')() +'/sib-api/common/floors/types'
   

    export default class Typefloors extends Component<Props> {
    ...
    render() {
      ...
      <ScrollView>
       ...
       <Text style={styles.input}>Add Type floors</Text>
