...
var urlgrid =require('../../const/bookapi')()+'sib-api/booking/bookings/bycurrentdate'
...
export default class GridsScreenlibre extends React.Component {
  ...
  renderRowThree = ({ item }) => (
    ...
    >
      <View style={styles.itemThreeSubContainer}>
        <Image source={{ uri: 'https://i.ibb.co/GxZZqWz/salle2.jpg' }} style={styles.itemThreeImage} />
