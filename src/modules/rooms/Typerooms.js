    ...
    var urlcnst = require('../../const/api')() +'/sib-api/common/rooms/types'
    ...
    var selectzoneid =[]
    var selectzonename =[]
    export default class Typerooms extends Component<Props> {
    ...
    render() {
      ...
      <ScrollView>
       ...
       <Text style={styles.input}>Add Type Room</Text>
